...
class Auth extends Controller {
    ...
    public function register() {
        ...
        if (isset($_POST['f_name']) && isset($_POST['name']) && isset($_POST['mail']) && isset($_POST['password']) && isset($_POST['retypePassword'])) {
            $errorMsg = NULL;
            ...
            if ($errorMsg) {
                ...
                $userId = $userModel->CreateNewUser($_POST['f_name'], $_POST['name'], $_POST['mail'], $_POST['password']);
